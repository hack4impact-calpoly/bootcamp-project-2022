...
const recipeData: Recipe[] = [
    {
        ...
        desc: "Corn on the cob is cooked in boiled water with a little sugar and lemon juice for the sweetest, tastiest corn! My mother-in-law gave me this easy recipe.",
    ...
    },
    {
        ...
        desc: "Onion rings are a popular appetizer at many restaurants, and with this recipe, you can satisfy your craving at home. This is an actual recipe from a former employee of a popular drive-in restaurant. Sweet and tender on the inside, crispy and crunchy on the outside — just like the pros make!",
    ...
    },
    {
        ...
        desc: "Good, old-fashioned, restaurant-style hash browns. Perfect with hot pepper sauce and ketchup!",
