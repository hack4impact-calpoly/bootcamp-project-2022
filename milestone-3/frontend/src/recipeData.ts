...
const recipes: Recipe[] = [
    ...
    image: "https://www.torani.com/sites/default/files/recipes/illustration/iced%20latte%20with%20swirl.jpg",
    ...
    instructions: ["First, add the instant coffee to a heat resistant mug and start boiling your water", "Then, add your choice of sweetener along with the coffee", "When the water is hot, pour the hot water into the mug to about 1/3 of the way",
    ...
    image: "https://allthehealthythings.com/wp-content/uploads/2021/05/planet-oat-iced-honey-cinnamon-latte-4.webp",
    ...
    image: "https://i.pinimg.com/originals/17/57/93/17579381dadd98182039430ae8edb7ed.jpg",
