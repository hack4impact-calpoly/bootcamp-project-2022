export interface Recipe {
  ...
  const recipes: Recipe[] = [
    ...
    "description": "Very cheesy and beefy carne asada quesadilla ... Prep Time: 5 minutes | Cook Time: 6 minutes",
    ...
    "description": "Very crispy sweet potato fries ... Prep Time: 30 minutes | Cook Time: 20 minutes",
  ...
  {
    "name": "Mexican Flan",
    "description": "Very caramelly Mexican Flan ... Prep Time: 20 minutes | Cook Time: 75 minutes",
