...
const recipes: Recipe[] = [
    ...
    ingredients: ["1 spoon of high garde ceremonial matcha (can adjust amount) *Note: The link above is the matcha brand I use and in my opinion has a great quality. You can order online or at Costco :) The more vibrant greent the matcha, the better!*", "Optional: 1 spoon sweetener of choice (I use maple syrup or honey and can adjust to your liking)", "Warm water (see Instructions for amount)", "Milk of choice (see Instructions for amount)", "Optional: Ice", "Optional: Fresh pureed strawberries, blueberries, or mangoes for aesthetic and elevating the taste! (Best for Iced)"],
