...
exports.recipeObj = exports.errorObject = void 0;
...
exports.recipeObj = [recipeObject1, recipeObject2, recipeObject3].map((recipe) => (Object.assign(Object.assign({}, recipe), { slug: slugify(recipe.name, { replacement: "_", lower: true }) })));
