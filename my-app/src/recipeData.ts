...
const recipes: Recipe[] = [
    {
        ...
        instructions: [
            ...
            'Next, use a fork or a whist to mix the eggs. Mix until blended.',
    ...
    },
    {
        ...
        instructions: [
            'First heat your quesadilla maker and add butter. If you dont have one, you can probably use a stove.',
    ...
    },
    {
        ...
        instructions: [
            ...
            'While the pasta is boiling, we create our sautee.',
            ...
            'Add in spinich and olives. Stir until spinach is wilted.',
